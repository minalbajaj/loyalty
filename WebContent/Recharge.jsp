...
function CalculateNewBalance(rechargeAmount)
{
	document.getElementById("newBalance").value=rechargeAmount+document.getElementById("cardBalance").value;
}
...
function validate_cardactivationForm(){
	...
	document.getElementById("hiddenCardId").value=document.getElementById("cardNumber").options[document.getElementById("cardNumber").selectedIndex].value;
...
<form name="cardactivation" method="post" action="CommonServlet">
	<input type="hidden" name="hiddenCardId" id="hiddenCardId" value=""/>	
	<input type="hidden" name="recharge" id="recharge" value="Recharge"></input>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
		<tr >
          ...
          <tr>
              <td><div align="left" style="height:25px;" class="pageheading">Prepaid Card Recharge</div></td></table>
              <td></td>
              <td align="right" valign="top"><div align="right" style="margin-right:10px; color:#990000;">
	...
	<%if(request.getParameter("cardNumber")!=null){ %>	
		<tr id="textbox2">
			<td colspan="2" align="right" valign="top"><div align="left"
					...
					Card Balance<span style="color: #FF0000"> *</span>
				</div>
			<td align="left" valign="top"><div align="left" class="labels">
					<b>:</b> <input type="text" name="cardBalance" id="cardBalance" value="<%= request.getAttribute("balance")%>" readonly="readonly">
				</div>
			</td>
		...
		<tr id="textbox3">
			<td colspan="2" align="right" valign="top">
				<div align="left" style="margin-left: 15px;" class="labels">
					Recharge Amount<span style="color: #FF0000"> *</span>
				</div>
			<td align="left" valign="top"><div align="left" class="labels">
					<b>:</b> <input type="text" name="rechargeAmount" id="rechargeAmount" style="width: 175px" onchange="CalculateNewBalance(this.value)">
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr id="textbox4">
			<td colspan="2" align="right" valign="top">
				<div align="left" style="margin-left: 15px;" class="labels">
					New Balance<span style="color: #FF0000"> *</span>
				</div>
			<td align="left" valign="top"><div align="left" class="labels">
		...
		<tr>
			...
			<td colspan="3" align="left">
				...
				<input type="hidden" name="prdcardactivate" id="prdcardactivate" value=""> 
					<input type="submit" name="rechargebutton" value="Recharge"
