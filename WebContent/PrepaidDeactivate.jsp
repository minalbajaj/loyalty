...
function validate_cardactivationForm(){
	...
	if(document.PrepaidCardDeactivation.cardNumber.value==0)
	{
		alert("Please enter member card number..");
		document.PrepaidCardDeactivation.cardNumber.focus();
		return false;
	}
...
<form name="PrepaidCardDeactivation" method="post" action="CommonServlet">
	
	<input type="hidden" name="deactivate" id="deactivate" value="Deactivate"></input>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
		<tr >
          ...
          <tr>
              <td><div align="left" style="height:25px;" class="pageheading">Prepaid Card Deactivation</div></td></table>
              <td></td>
              <td align="right" valign="top"><div align="right" style="margin-right:10px; color:#990000;">
