...
function validate_cardactivationForm(){
	...
	document.getElementById("postcardactivate").value='postpaidcardactivate';	
	return true;
...
<form name="cardactivation" method="post" action="CommonServlet">
	...
	<input type="hidden" name="activate1" id="activate1" value="Activate"></input>
  ...
  <%}}%>
		...
		<tr >
          ...
          <tr>
              <td><div align="left" style="height:25px;" class="pageheading">Postpaid Card Activation</div></td></table>
              <td>&nbsp;</td>
              <td align="right" valign="top"><div align="right" style="margin-right:10px; color:#990000;"></div>
			</td>
		</tr>
		
		
		<tr>
		    <td><input type="hidden" name="hiddenDiscountCalcOnes" id="hiddenDiscountCalcOnes" value="" /></td>
			
			<td>&nbsp;<input type="hidden" name="postcardactivate" id="postcardactivate" value="" /></td>
